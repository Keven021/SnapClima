...
const weatheDescription = document.getElementById("weather-description");
...
const api_key = "6151e7be63e45bd9dd77b9ac3ab31f59";
...
function displayWeather(data) {
    ...
    weatheDescription.textContent = description;
